...
function checkSolution(boardId) {
    const puzzle = exercisePuzzles[boardId];
    
    // For now, just show success after any move (can be enhanced with specific solutions)
    setTimeout(() => {
    ...
    if (success) {
        ...
        resultDiv.innerHTML = `
            <div class="error-message">
                ...
                <strong>Tente novamente!</strong> Esta não é a solução ideal.
            </div>
        `;
